...
class Cola_Com_Pager
{
    protected $_config = array(
        ...
        'nextNums'         => 7,
        'showSinglePage'   => true,
        'prefix'           => '<div class="page_box">',
        'first'            => '',
        'last'             => '',
        'prev'             => '<span class="pag"><a href="%link%" class="">上一页</a></span>',
        'next'             => '<span class="nex"><a href="%link%" class="">下一页</a></span>',
        'current'          => '<a href="javascript:;" class="active">%page%</a>',
        'page'             => '<a href="%link%">%page%</a>',
        'suffix'           => '</div><div class="fruit">共%totalItems%条结果，%curPage%/%totalPages%页</div>'
    );
