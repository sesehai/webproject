 ...
 *
 */
class Cola_Com_MsitePager {

    protected $_config = array(
        'prevNums' => 2,
        'nextNums' => 7,
        'showSinglePage' => false,
        'prefix' => '<div class="info-more j-more f-hide">',
        'first' => '',
        'last' => '',
        'prev' => '<span class="f-fl" data-page="prev"><a href="%link%">上一页</a></span>',
        'noprev' => '<span class="f-fl" data-page="prev">上一页</span>',
        'next' => '<span class="f-fr" data-page="next"><a href="%link%">下一页</a></span>',
        'nonext' => '<span class="f-fr" data-page="next">下一页</span>',
//	'next'             => '<div class="info-more j-more f-hide"><a href="%link%">查看更多</a></div>',
        'current' => '',
        'page' => '',
        'suffix' => '</div>'
    );
     ...
     * @param string $url
     * @param stirng $firstPage	    //第一页url，seo优化使用，防止产生两个第一页地址。
     */
    public function __construct($curPage = 1, $pageSize = 20, $totalItems, $url = '', $firstPage = '') {
    ...
    public function page($page, $format = null) {
        ...
        return 1 == $page ? str_replace(array_keys($p), $this->firstPage, $format) : str_replace(array_keys($p), $p, $format);
    }
