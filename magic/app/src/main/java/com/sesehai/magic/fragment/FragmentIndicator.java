...
public class FragmentIndicator extends LinearLayout implements OnClickListener {
    ...
    private void init() {
        ...
        mIndicators[0] = createIndicator(R.drawable.icon_tab_home_selected,
                R.string.tab_home, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
        //mIndicators[0].setBackgroundResource(R.drawable.icon_arrow_up);
        mIndicators[0].setTag(Integer.valueOf(0));
        mIndicators[0].setOnClickListener(this);
        addView(mIndicators[0]);
        mIndicators[1] = createIndicator(R.drawable.icon_tab_list,
                R.string.tab_list, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);
        mIndicators[1].setBackgroundColor(Color.alpha(0));
        mIndicators[1].setTag(Integer.valueOf(1));
        mIndicators[1].setOnClickListener(this);
        addView(mIndicators[1]);
        mIndicators[2] = createIndicator(R.drawable.icon_tab_user_center,
    ...
    public static void setIndicator(int which) {
        ...
        switch(mCurIndicator) {
            case 0:
                ...
                prevIcon.setImageResource(R.drawable.icon_tab_home);
            ...
            case 1:
                ...
                prevIcon.setImageResource(R.drawable.icon_tab_list);
            ...
            case 2:
                ...
                prevIcon.setImageResource(R.drawable.icon_tab_user_center);
        ...
        // mIndicators[which].setBackgroundResource(R.drawable.icon_arrow_up);
        ImageView currIcon;
        TextView currText;
        switch(which) {
            case 0:
                currIcon =(ImageView) mIndicators[which].findViewWithTag(TAG_ICON_0);
                currIcon.setImageResource(R.drawable.icon_tab_home_selected);
            ...
            case 1:
                ...
                currIcon.setImageResource(R.drawable.icon_tab_list_selected);
            ...
            case 2:
                ...
                currIcon.setImageResource(R.drawable.icon_tab_user_center_selected);
